    ...
    try {
      switch (accept.type(CN_TYPES)) {
        case 'text/html':
          ...
          } else if (materializedData && queryInfo.jsonldFrame) {
        ...
        case 'application/n-triples':
          callback(await this.rdfConverter.convert(RDF_TYPES.NT, data, queryInfo, callback));
          break;
        case 'application/n-quads':
          callback(await this.rdfConverter.convert(RDF_TYPES.NQ, data, queryInfo, callback));
          break;
