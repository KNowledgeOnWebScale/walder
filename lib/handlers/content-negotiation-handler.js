...
module.exports = class ContentNegotiationHandler extends Handler {
   ...
   * @param queryInfo, Query info object (see walder/lib/parsers/graphQLLDParser.js)
      ...
      switch (accept.type(CN_TYPES)) {
        ...
        case 'application/ld+json':
          ...
          if (queryInfo.jsonldFrame) {
            inputFormat = RDF_TYPES.JSON_LD;
          }

          callback(await this.rdfConverter.convert(RDF_TYPES.JSON_LD, data, queryInfo, inputFormat));
          break;
        case 'text/turtle':
