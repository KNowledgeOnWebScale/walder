...
module.exports = class SPARQLHandler extends Handler {
  ...
  async handle(queryInfo, pathParams = {}, queryParams = {}) {
    ...
    if (!(queryInfo.comunicaConfig.sources.toString() in this.comunicaEngineSourcesMap)) {
      queryInfo.comunicaConfig.sources = await parseDataSources({dataSources: queryInfo.comunicaConfig.sources, graphQLLDHandler: this.graphQLLDHandler, sparqlHandler: self, pipeModulesPath: this.pipeModulesPath});
