 ...
 *
 * Comunica caches data by default,so if query engines are reused, queries will be resolved quicker.
 *
...
module.exports = class GraphQLLD {
   ...
   */
  async executeQuery(comunicaConfig, graphQLLD, variables, queryParams) {
