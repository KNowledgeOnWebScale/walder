...
module.exports = class Walder {
  ...
  async initialise() {
    ...
    // Data sources
    const graphQLLDHandler = new GraphQLLDHandler(this.logger, resources['pipe-modules']);
    const sparqlHandler = new SPARQLHandler(this.logger, resources['pipe-modules']);
