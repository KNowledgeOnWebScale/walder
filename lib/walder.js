...
// Parsers
const parseResources = require('./parsers/resourceParser');
const parseRoute = require('./parsers/routeParser');
const parseGraphQLLD = require('./parsers/graphQLLDParser');
const parseParameter = require('./parsers/parameterParser');
const parsePipeModule = require('./parsers/pipeModuleParser');
const parseHTML = require('./parsers/htmlParser');
const parseConfigFile = require('./parsers/configFileParser');
const parseDataSources = require('./parsers/dataSourcesParser');
...
module.exports = class Walder {
  ...
  async initialise() {
    ...
    const yamlData = await parseConfigFile(this.configFile);
    ...
    for (let path in yamlData.paths) {
      ...
      for (let method in yamlData.paths[path]) {
        ...
        const htmlInfo = parseHTML(yamlData.paths[path][method].responses, resources.views, resources.layouts);
