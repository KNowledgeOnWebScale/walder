...
module.exports = class Walter {
  ...
  initialise() {
     ...
     * @param htmlInfo, {statusCode: HTMLInfo} object (see walter/lib/parsers/htmlParsers.js)
    ...
    const contentNegotiation = (data, htmlInfo, graphQLLD, req, res) => {
      ...
      try {
        switch (accept.type(CN_TYPES)) {
          case 'text/html':
            HtmlConverter.convert(htmlInfo['200'], data,
              (result) =>
                res
          ...
          case 'application/ld+json':
            RdfConverter.convert(RDF_TYPES.JSON_LD, data, graphQLLD,
              (result) =>
                res
            ...
            break;
          case 'text/turtle':
            RdfConverter.convert(RDF_TYPES.TURTLE, data, graphQLLD,
              (result) =>
                res
          ...
          case 'application/n-triples':
            RdfConverter.convert(RDF_TYPES.NT, data, graphQLLD,
              (result) =>
                res
          ...
          case 'application/n-quads':
            RdfConverter.convert(RDF_TYPES.NQ, data, graphQLLD,
              (result) =>
                res
        ...
        HtmlConverter.convert(htmlInfo['500'], {},
          (html) =>
            res
              .status(500)
              .send(html)
    ...
    const requestCallback = (graphQLLD, pipeFunctions, htmlInfo) => {
      if (graphQLLD) {
        ...
        return (req, res, next) => {
          HtmlConverter.convert(htmlInfo, {},
            (html) =>
              res
                .status(404)
                .send(html)
